...
-R  \"../results/Seurat/callpeaks_unsorted/0_peaks.bed\" \"../results/Seurat/callpeaks_unsorted/1_peaks.bed\" \\
\"../results/Seurat/callpeaks_unsorted/2_peaks.bed\" \"../results/Seurat/callpeaks_unsorted/3_peaks.bed\" \\
\"../results/Seurat/callpeaks_unsorted/4_peaks.bed\" \"../results/Seurat/callpeaks_unsorted/5_peaks.bed\" \\
\"../results/Seurat/callpeaks_unsorted/6_peaks.bed\" \\
-b 3000 \\
-a 3000 \\
--skipZeros \\
--missingDataAsZero \\
