...
computeMatrix reference-point -o ../results/deeptools/test.mat.gz -S \
 ../data/bw/extended_canonical_PQS_mm10_binary.bw \
 -R  ../results/Seurat/callpeaks_unsorted/peak_sets/test.bed \
