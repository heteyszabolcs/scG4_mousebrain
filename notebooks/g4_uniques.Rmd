---
title: "Unique G4 locations and their expressional patterns"
output:
  html_document:
    df_print: paged
...
params:
  ...
  oligodendr_markers: ../data/GSE75330/marker_genes.txt
  peak_sets: ../results/Seurat/callpeaks_unsorted/peak_sets/
---

__Summary:__
This notebook provides the steps below:\
1.) Find unique G4s by Grubb's outlier test\
2.) Integrate unique G4s external with scRNA-Seq\
3.) heatmap visualizations\

```{r}
suppressPackageStartupMessages({
  library("tidyverse", warn.conflicts = FALSE)
  library("wigglescout", warn.conflicts = FALSE)
  ...
  library("outliers", warn.conflicts = FALSE)
})
```
...
```{r}
cluster_bigwigs = list.files(params$bigwig_folder, pattern = "*[0-9].bw", full.names = TRUE)
peak_set = "enhancer_analysis_output.bed"
bed = glue("{params$peak_sets}{peak_set}")
...
write_tsv(
  bed_grubbs,
  glue("{params$result_folder}Grubbs_test-unique_G4_peaks_0.001.bed"),
  col_names = FALSE
)
...
Grubb's test heatmap
```{r}
pdf(
  file = glue(
    "{params$result_folder}read_density_hm-Signac_MACS2_peaks-Grubbs0.001.pdf"
  ),
  width = 4,
  height = 6
)
...
png(
  file = glue("{params$result_folder}read_density_hm-Signac_MACS2_peaks-Grubbs0.001.png"),
  width = 15,
  height = 15,
  units = "cm",
  res = 300
...
ggsave(
  glue("{params$result_folder}Grubbs_test-unique_G4_peaks_bar.png"),
  plot = n_uniques,
  width = 10,
  height = 10,
  dpi = 300,
...
ggsave(
  glue("{params$result_folder}Grubbs_test-unique_G4_peaks_bar.pdf"),
  plot = n_uniques,
  width = 6,
  height = 6,
  device = "pdf"
...
Following annotation of unique peaks by HOMER
```{r}
...
write_tsv(cluster6,
          glue("{params$result_folder}Grubbs_test-unique_G4_cluster6.bed"),
          col_names = FALSE)
...
write_tsv(
  mat_grubbs_max,
  glue(
    "{params$result_folder}Grubbs_test-unique_G4_peaks_0.001_joined.tsv"
  ),
  col_names = TRUE
)
...
__unique peak heatmaps__
integrate with Bartosovic scRNA-Seq data
...
png(
  file = glue(
    "{params$result_folder}heatmap_uniqueMACS2_peaks-scRNA_GSE163484-85.png"
  ),
  width = 15,
  height = 15,
  units = 'cm',
...
pdf(
  file = glue(
    "{params$result_folder}heatmap_uniqueMACS2_peaks-scRNA_GSE163484-85.pdf"
  ),
  width = 5,
  height = 5,
)
...
```{r}
markers = fread(params$oligodendr_markers, header = FALSE) # marker genes from Zhang et al. and Marques et al.
...
png(
  file = glue(
    "{params$result_folder}heatmap_oligo_markers-scRNA_GSE163484-85.png"
  ),
  width = 15,
  height = 15,
  units = 'cm',
...
pdf(
  file = glue(
    "{params$result_folder}heatmap_oligo_markers-scRNA_GSE163484-85.pdf"
  ),
  width = 6,
  height = 5,
)
...
integrate with Marques et al. scRNA-Seq data
...
png(
  file = glue(
    "{params$result_folder}heatmap_uniqueMACS2_peaks-scRNA_GSE75330.png"
  ),
  width = 15,
  height = 15,
  units = 'cm',
...
pdf(
  file = glue(
    "{params$result_folder}heatmap_uniqueMACS2_peaks-scRNA_GSE75330.pdf"
  ),
  width = 4.5,
  height = 7,
)
...
png(
  file = glue(
    "{params$result_folder}heatmap_uniqueMACS2_promoter_peaks-scRNA_GSE75330.png"
  ),
  width = 18,
  height = 19,
  units = 'cm',
...
pdf(
  file = glue(
    "{params$result_folder}heatmap_uniqueMACS2_promoter_peaks-scRNA_GSE75330.pdf"
  ),
  width = 8,
  height = 10
)
...
png(
  file = glue("{params$result_folder}heatmap_oligo_markers-scRNA_GSE75330.png"),
  width = 15,
  height = 15,
  units = 'cm',
  res = 500
...
pdf(
  file = glue(
    "{params$result_folder}heatmap_oligo_markers-scRNA_GSE75330.pdf"
  ),
  width = 6,
  height = 6
)
...
pdf(
  file = glue(
    "{params$result_folder}heatmap_uniqueMACS2_peaks-scRNA_GSE75330_.pdf"
  ),
  width = 6,
  height = 7.5
)
...
png(
  file = glue(
    "{params$result_folder}heatmap_uniqueMACS2_cl3-scRNA_GSE75330.png"
  ),
  width = 15,
  height = 15,
  units = 'cm',
...
pdf(
  file = glue(
    "{params$result_folder}heatmap_uniqueMACS2_cl3-scRNA_GSE75330.pdf"
  ),
  width = 5.5,
  height = 5,
)
...
png(
  file = glue(
    "{params$result_folder}heatmap_uniqueMACS2_cl4-scRNA_GSE75330.png"
  ),
  width = 15,
  height = 15,
  units = 'cm',
...
png(
  file = glue(
    "{params$result_folder}heatmap_uniqueMACS2_cl0-scRNA_GSE75330.png"
  ),
  width = 15,
  height = 15,
  units = 'cm',
...
png(
  file = glue(
    "{params$result_folder}heatmap_uniqueMACS2_cl5-scRNA_GSE75330.png"
  ),
  width = 15,
  height = 15,
  units = 'cm',
...
pdf(
  file = glue(
    "{params$result_folder}heatmap_uniqueMACS2_cl5-scRNA_GSE75330.pdf"
  ),
  width = 4.5,
  height = 5.5,
)
...
png(
  file = glue("{params$result_folder}heatmap_uniqueMACS2_cl6-scRNA_GSE75330.png"),
  width = 15,
  height = 15,
  units = 'cm',
  res = 500
...
pdf(
  file = glue(
    "{params$result_folder}heatmap_uniqueMACS2_cl6-scRNA_GSE75330.pdf"
  ),
  width = 5.5,
  height = 5.5,
)
